...
class ProfilerLog extends DefaultModel
{
    ...
    protected $fields = [
        'id' => 'ID лога',
        'uuid' => 'Uuid профилирования метода класса',
        'class' => 'Название класса профилирования',
        'method' => 'Название метода профилирования',
        'is_static' => 'Флаг статичного вызова метода',
        'arguments' => 'Аргументы метода',
        'status' => 'Статус выполнения метода',
        'result' => 'Результат метода',
        'exception' => 'Исключение метода',
        'count' => 'Количество вызовов метода',
        'duration' => 'Время выполнения метода',
        'memory' => 'Потребляемая память при выполнении метода',
        'info' => 'Информация о выполнении метода',

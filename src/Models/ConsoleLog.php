...
class ConsoleLog extends DefaultModel
{
    ...
    protected $fields = [
        'id' => 'ID лога',
        'uuid' => 'Uuid консольной команды',
        'name' => 'Название консольной команды',
        'command' => 'Название класса консольной команды',
        'cli' => 'Консольная команда',
        'output' => 'Вывод консольной команды',
        'result' => 'Результат выполнения консольной команды',
        'exception' => 'Исключение консольной команды',
        'status' => 'Статус выполнения консольной команды',
        'duration' => 'Время выполнения команды',
        'memory' => 'Потребляемая память при выполнении команды',
        'info' => 'Информация о выполнении консольной команды',

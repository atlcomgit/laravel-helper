...
class QueueLog extends DefaultModel
{
    ...
    protected $fields = [
        ...
        'job_id' => 'Идентификатор очереди',
        'job_name' => 'Название класса очереди',
        'name' => 'Название очереди',
        'connection' => 'Подключение очереди',
        'queue' => 'Название очереди',
        'payload' => 'Полезная нагрузка очереди',
        'delay' => 'Задержка выполнения очереди',
        'attempts' => 'Попытка запуска очереди',
        'status' => 'Статус выполнения очереди',
        'exception' => 'Исключение очереди',
        'duration' => 'Время выполнения очереди',
        'memory' => 'Потребляемая память при выполнении очереди',
        'info' => 'Информация о выполнении очереди',
